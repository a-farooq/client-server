    ...
    while True:
        try:
            ...
            #    enable()
                ...
                msg_list.insert(tkinter.END, msg)
                msg_list.itemconfig(tkinter.END, fg="black")
...
top.title("Word Chain Game v2.3")
...
lblscoretxt = tkinter.Label(row, text="Score: ", width=4)
lblscore = tkinter.Label(row, text='0', width=2)
# btnsend.pack(side=tkinter.LEFT)
row.pack(pady=5)
txtbox.pack(side=tkinter.LEFT, padx=5)
lblscore.pack(side=tkinter.RIGHT, padx=5)
lblscoretxt.pack(side=tkinter.RIGHT, padx=5)
